...
export const sink_or_be_sunk_content = new Section(
  ...
  description,
  {
    ...
    photos: [
      ...
      { href: 'sink-or-be-sunk/AccountPage.png', type: 'wide' },
      // { href: 'sink-or-be-sunk/DevicePairing.gif', type: 'wide' },
